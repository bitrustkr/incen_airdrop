...
router.post('/invite', async function(req, res, next) {
    ...
    try{
        ...
        console.log('referral_count : ' + userRst[0].referral_count);
        console.log('Mission Valu : ' + missionRst[0].value);

        if(missionRst[0].value > userRst[0].referral_count){
            result.message = 'The number of invited people is not enough.';

            throw new Error("The number of invited people is not enough.");
        }
